...
export interface CryptoPropFirmsCopy {
  kicker: string;
  h1: string;
  intro: string;
...
export function CryptoPropFirmsContent({
  copy,
  prefix,
  firms,
  summaries,
}: {
  copy: CryptoPropFirmsCopy;
  prefix: string;
  ...
  return (
    <div className="mx-auto max-w-[820px]">
      ...
      <section className="mt-12">
        ...
        <BulletList items={copy.changesItems} />
      </section>
      ...
      <section className="mt-12">
        ...
        <p className="mt-3 text-[16px] leading-[24px] text-body">{copy.trackRecordBody}</p>
      </section>
