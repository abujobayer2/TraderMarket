...
export interface FuturesPropFirmsCopy {
  kicker: string;
  h1: string;
  intro: string;
  ...
  drawdownBody: string;
  flatByCloseHeading: string;
  flatByCloseItems: string[];
...
export function FuturesPropFirmsContent({
  copy,
  prefix,
  firms,
  summaries,
}: {
  copy: FuturesPropFirmsCopy;
  prefix: string;
  ...
  return (
    <div className="mx-auto max-w-[820px]">
      ...
      <section className="mt-12">
        <h2 className="text-[24px] font-semibold leading-[30px] tracking-[-0.6px] text-ink">
          {copy.flatByCloseHeading}
        </h2>
        <BulletList items={copy.flatByCloseItems} />
      </section>
